...
To set up your environment for success, follow the [technical setup](contributing/technical-setup.md) guidelines.
...
![deploy-preview](contributing/deploy-preview.png)
